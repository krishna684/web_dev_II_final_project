  ...
  return (
    <div className="page">
      <div className="row between" style={{marginBottom: 24, alignItems:'flex-end'}}>
        <div>
          <h1>Your Sides</h1>
          <div className="sub">Design, edit, and explore each side of yourself.</div>
        </div>
...
function PersonaEditor({ persona, onSave, onCancel, onDelete, isNew }) {
  ...
  return (
    <div className="page">
      <div className="row between" style={{marginBottom: 24, alignItems:'flex-end'}}>
        <div>
          <h1>{isNew ? 'Create Side' : `Edit Side`}</h1>
        ...
        <div className="row" style={{gap:8}}>
          ...
          <button className="btn btn-primary" onClick={save}><Ic.save/> {isNew ? 'Create Side' : 'Save changes'}</button>
        </div>
      </div>
